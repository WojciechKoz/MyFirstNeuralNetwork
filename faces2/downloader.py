...
def multi_photos_operations(num_of_link_line):
...
def one_photo_operations(num_of_link_line):
    num_of_link_line = int(num_of_link_line)
...
for i in range(1, 50000): 
    ...
    if len(num_of_link_line) < 2:
        num_of_link_line = bash("awk '/1 of /{ print NR; exit }' temp.txt")
        link, name = multi_photos_operations(num_of_link_line)
    else:
        link, name = one_photo_operations(num_of_link_line)
